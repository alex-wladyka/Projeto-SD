...
public class SkillUpdate {
    public static String IUpdateSkillProcess(PrintWriter out, BufferedReader in, String token, String skill, String novaSkill, String experience) throws IOException {
